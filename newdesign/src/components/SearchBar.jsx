...
const LOCATION_SUGGESTIONS = [
  ...
  { label: 'Austin, TX', sub: 'United States' },
];
  ...
  return (
    <div ref={ref} className="relative w-full max-w-4xl mx-auto">
      ...
      >
        ...
        {/* Search Button */}
        <Button className="mt-2 md:mt-0 md:ml-2 rounded-full bg-foreground hover:bg-foreground/90 text-background px-8 py-6 text-sm font-semibold transition-all duration-200 hover:scale-105 flex-shrink-0">
          Search
        </Button>
      </motion.div>
      ...
      <AnimatePresence>
        {activeDropdown === 'treatment' && (
          <motion.div
            ...
            className="absolute top-[calc(100%+8px)] left-0 w-72 bg-white rounded-2xl shadow-2xl border border-border/30 overflow-hidden z-50"
          >
            <div className="p-3">
      ...
      <AnimatePresence>
        {activeDropdown === 'location' && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 8 }}
            transition={{ duration: 0.18 }}
            className="absolute top-[calc(100%+8px)] left-1/3 w-80 bg-white rounded-2xl shadow-2xl border border-border/30 overflow-hidden z-50"
          >
            <div className="p-3">
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider px-2 mb-2">
      ...
      <AnimatePresence>
        {activeDropdown === 'datetime' && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 8 }}
            transition={{ duration: 0.18 }}
            className="absolute top-[calc(100%+8px)] right-0 bg-white rounded-2xl shadow-2xl border border-border/30 overflow-hidden z-50 w-full max-w-[560px]"
          >
