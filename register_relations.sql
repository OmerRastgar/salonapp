...
DELETE FROM directus_relations WHERE many_collection IN ('vendor_categories', 'employees', 'employee_services', 'employee_schedules', 'working_hours', 'bookings', 'reviews');
